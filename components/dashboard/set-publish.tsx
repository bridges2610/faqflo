      ...
      <label className="mt-3 block">
        ...
        <span className="mt-1.5 flex flex-wrap items-center gap-2">
          ...
          <input
            ...
            disabled={saving}
            placeholder="/faq"
            className="border-line text-navy focus:border-primary min-h-10 min-w-0 flex-1 rounded-input border bg-surface px-3 py-1.5 font-mono text-base sm:text-xs outline-none transition-colors duration-150 sm:min-h-0"
          />
        </span>
      </label>
