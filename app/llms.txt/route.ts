...
export function GET(): Response {
  ...
  const body = [
    ...
    */
    ...
    `- [Done for you](${SITE_URL}/done-for-you): a hands-on setup service — the audit worked, answers written and published to your site, and 90 days of tracking reported back.`,
